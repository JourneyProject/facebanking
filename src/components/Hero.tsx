...
const FACEBANK_WARREN_TEXT = "Hi I’m reaching out about the 2020 election! You may know that I’m all in for Bernie because of issues like healthcare and climate change. I noticed you liked Elizabeth Warren’s page. Now that Senator Warren has suspended her campaign I truly believe Bernie is our best chance to forever change the status quo. Have you made up your mind about who you’ll be supporting?"
...
const candidateLinks = {
    ...
    warren: ["https://m.facebook.com/nt/?id=%2Fpages%2Fentity%2Fstream%2F%3Fpage_id%3D38471053686%26fetcher%3Dfriends_who_liked", "https://www.facebook.com/pg/elizabethwarren/community"]
}
                    ...
                    <Tabs defaultActiveKey={Candidates.SANDERS} id="uncontrolled-tab-example">
                        ...
                        <Tab eventKey={Candidates.WARREN} title="Message Warren Supporters">
                            ...
                            <ol>
                                ...
                                <li>Click anywhere on the below text to copy it to your clipboard</li>
                                <li>Click the big red button <i>(this will open a new window{!IS_FIREFOX_DESKTOP && <span> into FB Messenger</span>})</i></li>
                                {IS_FIREFOX_DESKTOP && <li>Scroll down on the page that opens. You'll see a list of your friends who have liked Elizabeth Warren's page. Reach out to them via messenger! <i>(Applicable for Firefox on Desktop Only)</i></li>}
                                {!IS_FIREFOX_DESKTOP && !IS_MOBILE && <li>In the new window, click the <i className="fab fa-facebook-messenger"></i> next to a friends name <i>(Remember, these are friends <b>who like Elizabeth Warren</b>)</i></li>}
                                {IS_MOBILE && <li>In the new window, click your friend's name <i>(Remember, these are friends <b>who like Elizabeth Warren</b>)</i></li>}
                                {IS_MOBILE && <li>Reach out to them via messenger!</li>}
                            </ol>
                            <CopyToClipboard text={FACEBANK_WARREN_TEXT}>
                                <Card className="copy-area">
                                    <Card.Body>{FACEBANK_WARREN_TEXT}</Card.Body>
                                </Card>
                            </CopyToClipboard>
                            <CopyToClipboard text={FACEBANK_WARREN_TEXT}>
                                <Button variant="danger" block size="lg" className="cta" onClick={() => openFacebook(Candidates.WARREN)}><i className="fab fa-facebook-messenger"></i>&nbsp;&nbsp;Facebank Warren Supporters Here!</Button>
                            </CopyToClipboard>
                        </Tab>
                    </Tabs>
                </Col>
